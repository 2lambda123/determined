...
-  ``determinedai/environments-dev:cuda-11.3-pytorch-1.12-tf-2.11-gpu-0.24.0`` for NVIDIA GPUs.
-  ``determinedai/environments-dev:py-3.8-pytorch-1.12-tf-2.11-cpu-0.24.0`` for CPUs.
