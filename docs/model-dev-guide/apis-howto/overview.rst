...
-  ``determinedai/environments-dev:cuda-11.8-pytorch-2.0-tf-2.11-gpu-0.24.0`` (default)
...
-  ``determinedai/environments-dev:py-3.10-pytorch-2.0-tf-2.11-cpu-0.24.0``
-  ``determinedai/environments:py-3.7-pytorch-1.7-tf-1.15-cpu-0.23.3``
-  ``determinedai/environments-dev:py-3.10-tf-2.8-cpu-0.24.0``
