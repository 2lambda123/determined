...
class StateManager:
    """StateManager controls the userspace trial state updates.

    For unmanaged / detached trials, this class will report the state changes
    to the determinedmaster.
...
class ManagedTrialStateManager(StateManager):
    """
    ManagedTrialStateManager leaves the state management to the server.
    """
...
class UnmanagedTrialStateManager(StateManager):
    """
    UnmanagedTrialStateManager updates the state on context enter/exit.
    """
