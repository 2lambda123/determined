...
def main():
    ...
    max_epochs = det.info.trial.hparams["max_epochs"]
    ...
    if latest_checkpoint is not None:
        initial_epoch = det.checkpoint.get_metadata(latest_checkpoint)["epoch_idx"] + 1
    ...
    for epoch_idx in range(initial_epoch, max_epochs):
        ...
        for batch_idx, (data, label) in enumerate(train_dataloader):
            ...
            det.train.report_training_metrics(
        ...
        with det.checkpoint.store_path(
